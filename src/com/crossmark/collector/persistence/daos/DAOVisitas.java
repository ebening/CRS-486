...
public interface DAOVisitas {
    List<Map<String, Object>> getVisitasByIdTienda(int idTienda);
    
    List<Map<String, Object>> visitasByTerritorios(int TerritorioId,int EquiposId, int UnidadesNegociosId);
    
    List<Map<String, Object>> visitasTiendas(int RutaId, int VisitasId);
