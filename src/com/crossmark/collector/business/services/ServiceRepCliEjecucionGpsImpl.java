 ...
 * @author franciscom
 */
public class ServiceRepCliEjecucionGpsImpl implements ServiceRepCliEjecucionGps, Serializable{
    ...
    private DAOUsuariosTiendas daoUsuariosTiendas;//Proyecto
    private DAOEncuestasUsuarios daoEncuestasUsuarios;//Proyecto
    ...
    @Override
    public List<EncuestasUsuarios> getEncuestasPorUsuario(String usuariosOID,Integer clientesId,Integer regionesId, Integer territoriosId, Integer equiposId, Integer proyectosId) {
